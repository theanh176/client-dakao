					...
					<div className="w-2/3 max-lg:w-full flex flex-col justify-start items-start gap-3">
						...
						<div className="flex justify-start items-center gap-4 max-md:flex-col max-md:items-start max-md:gap-2">
							...
							<div className="cursor-pointer">
								<div className="transition-all w-10 h-10 hover:w-40 overflow-hidden rounded-md text-[#155979] flex justify-start items-center">
									<div className="w-10 min-w-[40px] h-10 flex justify-center items-center text-[#155979] hover:text-[#4ba3da]">
										<AiOutlineShareAlt className="w-5 h-5" />
									</div>
									{/* <div className="w-10 h-10 flex justify-center items-center text-[#155979] hover:text-[#4ba3da]">
										<PiMessengerLogoFill className="w-5 h-5" />
									</div> */}
									<div className="w-10 h-10 flex justify-center items-center text-[#155979] hover:text-[#4ba3da]">
